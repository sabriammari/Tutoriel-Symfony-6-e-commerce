<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2 chapitre">
    ...
    class SendMailService
    {
        ...
        ): void
        {
            ...
            <p>Nous allon créer un nouveau dossier "emails" dans le dossier "templates" et vous allez créer un fichier nommé "register.html.twig"</p>
    ...
    class JWTService
    {
        ...
        */
        ...
        public function check(string $token, string $secret)
        {
            ...
            <p>Et enfin nous allons modifier le fichier "RegistrationController" dns le répertoire "src/Controller" avec ce code :</p>
            <div class="bg-dark w-75 h-auto mx-auto border border-4 border-warning rounded-5 text-info bg-dark px-3 py-1 my-1">
                <pre>
                    <code>
