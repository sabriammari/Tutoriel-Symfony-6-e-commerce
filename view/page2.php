    ...
    <div id="page2" class="page">
        ...
        <div>
            ...
            <p>Pour cela ouvrir votre fichier "php.ini", qui se trouve dans le répertoire de PHP, avec un
                éditeur de texte,
                ensuite recherchez en tapant directement "Ctrl+F" le terme "intl",
        ...
        <div>
            ...
            <p>La ligne APP_SECRET= * , servira au jeton CSRF Pour la validation des formulaires, à modifier
                lors du passage
                en production.</p>
            <p>Pour la configuration de la base de données :</p>
            <ul>
                <li>Commentez la ligne "postgresql" avec un #</li>
                <li>Décommentez la ligne "mysql" en retirant le #</li>
