<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2">
    <div id="page16" class="page">
        ...
        <div>
            ...
            <p>Dans le répertoire "templates/admin/products", nous allons créer un nouveau fichier nommé "add.html.twig", nous y insererons ce code :</p>
            ...
            <p>Ensuite dans le répertoire "templates/admin/products", nous allons créer un nouveau fichier nommé "edit.html.twig", nous y insererons ce code :</p>
            ...
            <p>Voila à quoi ressemblera le fichier "yaml.twig" après modification :</p>
