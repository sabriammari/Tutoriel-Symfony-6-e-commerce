<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2 chapitre">
    <div id="page6" class="page">
        ...
        <div>
            ...
            <p>Les entités que nous avons créées contiennent des informations redondantes qui peuvent être optimisées. nous allons également ajouter des slugs dans les entités qui peuvent le nécessiter.
                Les redondances.</p>
            <p>Nous retrouvons différentes propriétés identiques dans différentes entités, comme created_at par exemple, qui se trouve dans les entités Users, Products, Orders et Coupons. On y trouve également à chaque fois les accesseurs getCreatedAt et setCreatedAt.
                Nous aurons la possibilité de limiter ces redondances en sortant ce code dans un Trait.</p>
            <p>Nous allons créer un dossier nommé "Trait" dans le répertoire "src/Entity", dans ce dossier nous créerons un fichier nommé "CreateAtTrait.php"</p>
    ...
    return $this;
        ...
        <div>
            ...
            <p>Pour pouvoir générer des données exemple pour la base de données, nous allons installer le composant orm-fixtures dans notre projet au moyen de la commande suivante :
            ...
            <p>Vous devez rajouter une ligne de code dans le fichier "Categories.php" situé dans le dossier "src/Entity", afin qu'il puisse supprimé avec les clés étrangères, ce qui donne ceci :</p>
            ...
            <p>Enfin nous pouvons ecrire cette ligne de commande afin de loader les dataFixtures :<br><span class="text-info bg-dark px-2 pb-1">symfony console doctrine:fixtures:load --no-interaction</span></p>
        ...
        <div>
            ...
            <p>Puis nous pouvons ecrire cette ligne de commande afin de loader les dataFixtures :<br><span class="text-info bg-dark px-2 pb-1">symfony console doctrine:fixtures:load --no-interaction</span></p>
            <p>Voici ce que cela donne dans PHPMyAdmin :</p>
        ...
        <div>
            ...
            <p>Enfin nous pouvons maintenant loader notre base de données avec toutes les informations préparées en amont grace aux dataFixtures.</p>
