<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2 chapitre">
    <div id="page10" class="page">
        ...
        <div>
            ...
            <p>Tout d'abord nous allons rajouter une propriété à notre entité "Users", dans le fichier "Users" situé dans le dossier "src/Entity", vous pouvez rajoutez cette ligne :</p>
            <ul>
