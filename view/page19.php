<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2">
    ...
    class MainController extends AbstractController
    {
        ...
        public function index(): Response
        {
            ...
            <p>Nous allons créer maintenant un nouveau fichier "index.html.twig" qui sera situé dans le répertoire "templates/admin/categories" et nous ya jouterons ce nouveau code comme ceci :</p>
            <a target="_blank" href="assets/img/Capture_Creation_Fichier_indexHtmlTwigAdminCategories.png">
                ...
                <p>Nous allons créer de même un nouveau fichier "index.html.twig" qui sera situé dans le répertoire "templates/admin/produits" et nous ya jouterons ce nouveau code comme ceci :</p>
        ...
        <div>
            ...
            <p>Pour la création du contrôleur utilisateur nous allon voir que c'est à peu près la même chose que les admins mais en y rajoutera des rôles pour chacun.</p>
