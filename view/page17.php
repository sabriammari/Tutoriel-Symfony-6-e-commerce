<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2">
    <div id="page17" class="page">
        ...
        <div>
            ...
            <p>Nous allons vérifier si le dossier "public/assets/uploads" existe et contient bien 3 images que nous téléchargés ultérieurement lors de la création des vues du produit.</p>
            <p>Si ce n'est pas le cas, alors téléchargez 3 images d'écrans et placez les dans ce dossier.</p>
            <p>Dans les parametres du fichier "services.yaml" situé dans le répertoire "config" rajoutez cette ligne de code, faites attention à l'indentation :<br>
            ...
            <a target="_blank" href="assets/img/Capture_Modification_Fichier_servicesYaml.png">
                <img class="w-100 pe-3 py-3 my-1" src="assets/img/Capture_Modification_Fichier_servicesYaml.png" alt="Capture d'écran de la modification du fichier services.yaml"></a>
            <p>Vous pouvez aller voir le tutoriel sur les manipulations des images en PHP sur ce lien :<br></p>
            <a href="https://www.youtube.com/watch?v=yFbYcgIUdqU&list=PLBq3aRiVuwyzPl8lh6lrdBXBnSpjLKwZi&index=17" target="_blank">https://www.youtube.com/watch?v=yFbYcgIUdqU&list=PLBq3aRiVuwyzPl8lh6lrdBXBnSpjLKwZi&index=17</a>
    ...
    class PictureService
    {
        ...
        public function delete(string $fichier, ?string $folder = '', ?int $width = 250, ?int $height = 250)
        {
            ...
            <p>Si la bibliothèque GD n’est pas activée, localisez et ouvrez le fichier php.ini dans votre éditeur.
                Recherchez la ligne ;extension=gd et supprimez le point-virgule pour activer l’extension.
            ...
            <a target="_blank" href="assets/img/Capture_PHP_Extension_gd.png">
                <img class="w-25 pe-3 py-3 my-1" src="assets/img/Capture_PHP_Extension_gd.png" alt="Capture d'écran de la création du fichier PictureService.php"></a>
