<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2 chapitre">
    <div id="page8" class="page">
        ...
        <div>
            ...
            <p>Avant de commencer, nous allons rajouter des lignes pour créer un nouvelle propriété "categoryOrder" dans l'entité "Categories" donc le fichier "Categories.php" qui est dans le répertoire "src/Entity" :</p>
