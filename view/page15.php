<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2">
    <div id="page15" class="page">
        ...
        <div>
            ...
            <p>Nous mettons en place la gestion des permissions utilisateurs en utilisant les <span class="fst-italic fw-bolder">voters</span> por notre projet</p>
            ...
            <p>Nous avons déjà créé, au début du tutoriel, un rôle administrateur qui lui a tous droits et on l'avait appelé ["ROLE_ADMIN"]</p>
            <p>Nous allons déclarer les différents rôles donnés et les hierarchiser.</p>
            <p>Dans le fichier "security.yaml" situé dans le répertoire "config/packages" nous allons modifier les roles, faites attention à l'indentation :</p>
    ...
    class ProductsController extends AbstractController
    {
        ...
        public function index(UsersRepository $usersRepository): Response
        {
            ...
            <p>Puis nous allons créer un nouveau dossier "products" dans le répertoire "templates/admin" et nous créerons un nouveau fichier "index.html.twig", 
                nous y insererons un code comme l'image ci-dessous :</p>
