    ...
    <div class="row mx-2">
        <aside class="col-11 col-md-3 mx-md-auto p-4 text-center rounded-2 my-4">
            <nav class="navbar navbar-expand-md bg-transparent justify-content-end navTableMatieres w-100">
                <button class="navbar-toggler bg-white border border-5 border-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbarOffcanvasMd" aria-controls="navbarOffcanvasMd" aria-label="Toggle navigation">
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="navbarOffcanvasMd" aria-labelledby="navbarOffcanvasmdLabel">
                    ...
                    <form class="justify-content-center mb-3 px-3">
                        <input id="searchInput" type="text" name="searchInput" class="align-self-center form-control border-dark mb-2 mb-sd-2 mb-md-2 mb-lg-0" placeholder="Rechercher">
                    </form>
                    <div class="offcanvas-title fw-bold text-center fs-3 mx-3 mb-4 border-bottom border-secondary" id="offcanvasExampleLabel">Table des matières</div>
                    <div class="offcanvas-body text-start">
                        <ul class="flex-column navbar-nav w-100 justify-content-between">
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#installation-collapse" aria-expanded="false" role="img">
                                ...
                                <div class="collapse" id="installation-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        ...
                                        <li><a href="?page=1#installationSymfony" class="text-decoration-none link-dark">
                                                1.2 - Installation de
                                                Symfony 6</a>
                                        </li>
                                    </ul>
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#createProject-collapse" aria-expanded="false" role="img">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#createBDD-collapse" aria-expanded="false" role="img">
                                ...
                                <div class="collapse" id="createBDD-collapse">
                                    <ul class="list-unstyled fw-normal pb-1 ms-4">
                                        ...
                                        <li><a href="?page=3#entityUsersCreate" class="text-decoration-none link-dark">
                                                ...
                                                table Users</a></li>
                                        <li><a href="?page=3#entityCategoriesCreate" class="text-decoration-none link-dark">
                                                3.5 - Création des entités de la
                                                table Categories</a></li>
                                        <li><a href="?page=3#entityCouponsCreate" class="text-decoration-none link-dark">
                                                3.6 - Création des entités de la
                                                table Coupons</a></li>
                                        <li><a href="?page=3#entityProductsCreate" class="text-decoration-none link-dark">
                                        ...
                                        <li><a href="?page=3#entityOrdersCreate" class="text-decoration-none link-dark">
                                                ...
                                                table Orders</a></li>
                                        <li><a href="?page=3#entityOrdersDetailsCreate" class="text-decoration-none link-dark">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#createTemplates-collapse" aria-expanded="false" role="img">
                                ...
                                <div class="collapse" id="createTemplates-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        <li><a href="?page=4#defaultPage" class="text-decoration-none link-dark">
                                                ...
                                                du serveur
                                                Symfony</a></li>
                                        <li><a href="?page=4#createMainController" class="text-decoration-none link-dark">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#createInscription-collapse" aria-expanded="false" role="img">
                                ...
                                <div class="collapse" id="createInscription-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        ...
                                        <li><a href="?page=5#createFormInscription" class="text-decoration-none link-dark">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#optimisation-collapse" aria-expanded="false" role="img">
                                ...
                                <div class="collapse" id="optimisation-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        ...
                                        <li><a href="?page=6#ProductsdataFixtures" class="text-decoration-none link-dark">
                                                6.4 - Mise en place des DataFixtures pour les entités "Products" et "Images"</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#createController-collapse" aria-expanded="false" role="img">
                                ...
                                <div class="collapse" id="createController-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        ...
                                        <li><a href="?page=7#productsControllerCreateManually" class="text-decoration-none link-dark">
                                                7.2 - Création d'un contrôleur "Products" manuellement</a>
                                        </li>
                                        <li><a href="?page=7#usersControllerCreateManually" class="text-decoration-none link-dark">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#viewIntegrate-collapse" aria-expanded="false" role="img">
                                ...
                                <div class="collapse" id="viewIntegrate-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        ...
                                        <li><a href="?page=8#categroyIntegration" class="text-decoration-none link-dark">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#emailVerif-collapse" aria-expanded="false" role="img">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#passwordRecup-collapse" aria-expanded="false" role="img">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#errorPage-collapse" aria-expanded="false" role="img">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#updateSymfony-collapse" aria-expanded="false" role="img">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#productsDetails-collapse" aria-expanded="false" role="img">
                                    <span class="fst-normal fw-semibold"> 13 - Accès des données et création de la page détails des produits
                                    </span>
                                </i>
                                <div class="collapse" id="productsDetails-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        <li><a href="?page=13#detailsProductsPageCreate" class="text-decoration-none link-dark">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#paginationConfig-collapse" aria-expanded="false" role="img">
                                    <span class="fst-normal fw-semibold"> 14 - Mise en place de la pagination sans bundle
                                    </span>
                                </i>
                                <div class="collapse" id="paginationConfig-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        <li><a href="?page=14#paginationCreateWithoutBundle" class="text-decoration-none link-dark">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#usersPermission-collapse" aria-expanded="false" role="img">
                                    <span class="fst-normal fw-semibold"> 15 - Mise en place des permissions utilisateurs
                                    </span>
                                </i>
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#formAddProducts-collapse" aria-expanded="false" role="img">
                                    <span class="fst-normal fw-semibold"> 16 - Creation du formulaire d'ajout de produits
                                    </span>
                                </i>
                                <div class="collapse" id="formAddProducts-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        <li><a href="?page=16#formCreateAddModifProducts" class="text-decoration-none link-dark">
                                                16.1 - Création des formulaires d'ajout et de modification de produits</a>
                                        </li>
                                        <li><a href="?page=16#addModifControllerCreate" class="text-decoration-none link-dark">
                                                16.2 - Création des contrôleurs d'ajout et de modification des produits</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#uploadImages-collapse" aria-expanded="false" role="img">
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#formOptimisation-collapse" aria-expanded="false" role="img">
                                    <span class="fst-normal fw-semibold"> 18 - Optimisation et validation des formulaires
                                    </span>
                                </i>
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#interfaceAdminCreate-collapse" aria-expanded="false" role="img">
                                    <span class="fst-normal fw-semibold"> 19 - Création d'une interface d'administration sans bundle
                                    </span>
                                </i>
                            ...
                            <li class="mb-1">
                                <i class="chevron bi bi-chevron-right collapsed" data-bs-toggle="collapse" data-bs-target="#shoppingGestion-collapse" aria-expanded="false" role="img">
                                ...
                                <div class="collapse" id="shoppingGestion-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ms-4">
                                        <li><a href="?page=20#controllerCartCreate" class="text-decoration-none link-dark">
