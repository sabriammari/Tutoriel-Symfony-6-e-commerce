<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2">
    <div id="page18" class="page">
        ...
        <div>
            ...
            <p>Dans notre fichier "Products.php" situé dans le répertoire "src/Entity", nous pouvons ajouter des contraintes de validités des champs "Nom" et "Stocks".</p>
            ...
            <p>Pour plus d'informations sur la validation sur Symfony; il y a la documentation dans leur site :</p>
