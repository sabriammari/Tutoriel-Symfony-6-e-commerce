<div class="text-bg-light p-4 mb-4 mx-auto border border-secondary rounded-2 chapitreActive">
    <div id="page1" class="page">
        ...
        <div>
            ...
            <ul>
                <li><span class="text-info bg-dark px-2 pb-1">Set-ExecutionPolicy RemoteSigned -Scope
                        CurrentUser # Optional: Needed to run a remote script the first time</span></li>
                <li><span class="text-info bg-dark px-2 pb-1">irm get.scoop.sh | iex</span></li>
            </ul>
